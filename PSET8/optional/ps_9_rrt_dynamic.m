...
while ~nearGoal
    ...
    elseif strcmp(method, 'lqr')
        [closest_vert,K,I] = closestVertexLQR(rrt_verts(:,1:N),xy); % Write this function
    end
    ConnM(N) = I;
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
n=1;
while(vertCi1~=1)
vertCi=ConnM(vertCi1-1);
plot(rrt_verts(1,vertCi),rrt_verts(2,vertCi),'bo','MarkerFaceColor','r','MarkerSize',5);
trajI(n)=vertCi;n=n+1;
vertCi1=vertCi;
pause(0.1)
end
trajI=flipud(trajI(1:n-1));
xpath=rrt_verts(:,trajI)';
addpath('..\..\Pendulum')
ps_9_visualizePath